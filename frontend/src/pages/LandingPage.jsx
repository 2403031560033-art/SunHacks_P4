    ...
    <div className="min-h-screen bg-dark-900 overflow-hidden relative selection:bg-accent-purple/30">
      ...
      <nav className="relative z-20 flex justify-between items-center px-8 py-6 fade-in-up">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-slate-900 tracking-tight">OrgMemory</span>
        </div>
        <div className="flex gap-4">
          ...
          <button 
            ...
            className="px-5 py-2.5 rounded-xl bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 transition-all shadow-md shadow-blue-600/20"
          >
            Get Started
          </button>
        </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-100px)] px-4 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-600 text-xs font-bold tracking-wide uppercase mb-8 fade-in-up delay-100 shadow-sm">
          <Sparkles className="w-3.5 h-3.5" />
          <span>Next-Gen Agentic Platform</span>
        </div>
        
        <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-slate-900 to-slate-600 tracking-tight max-w-4xl mb-6 fade-in-up delay-200">
          The memory engine for <br/> agentic enterprises.
        </h1>
        
        <p className="text-lg md:text-xl text-slate-500 max-w-2xl mb-12 font-medium leading-relaxed fade-in-up delay-300">
        ...
        <div className="flex flex-col sm:flex-row gap-4 fade-in-up delay-400">
          <button 
            onClick={() => navigate('/register')}
            className="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-sky-500 text-white font-bold text-lg hover:shadow-[0_0_40px_rgba(59,130,246,0.4)] hover:scale-105 transition-all flex items-center justify-center gap-2"
          >
          ...
          <button 
            onClick={() => navigate('/login')}
            className="px-8 py-4 rounded-xl bg-white border border-slate-200 text-slate-700 font-bold text-lg hover:bg-slate-50 hover:shadow-md transition-all shadow-sm"
          >
            Watch Demo
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24 max-w-5xl w-full fade-in-up delay-400">
          {[
            ...
            <div key={i} className="p-6 rounded-2xl bg-white/70 backdrop-blur-xl border border-slate-200 text-left interactive-element shadow-sm">
